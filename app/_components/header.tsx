          ...
          <header className="flex z-50 items-center gap-4 justify-between px-3 py-2 border-b border-dark-gray4 sticky top-0 bg-dark-gray1">
            <Link className="flex items-center gap-2 group" href="/">
              <img
                ...
                className="border select-none border-dark-gray6 w-6 h-6"
                draggable={false}
              />
              <div className="sm:flex hidden flex-col gap-1.5 text-center">
                <h1 className="text-xs text-dark-gray12 transition-colors">
                  {data.index.title}
                </h1>
              </div>
            </Link>
            <nav className="text-sm flex flex-row gap-4 text-dark-gray10">
