...
export interface Scalars {
  ...
  type: "file"
    ...
    BSHBSelect_1985231500: 'issue' | 'pr',
    BSHBSelect__1970461833: 'Closed' | 'Issue' | 'Link2Icon' | 'Pencil1Icon' | 'Pr' | 'ReaderIcon' | 'X',
    Boolean: boolean,
...
export type BlockDocument = (CalloutComponent | Components | Contributions | Fonts | Header | Index | LinkComponent | MetaComponent | NavLinks | PopoverComponent | Posts | PostsItem | PostsSection | RecentContributionsSection | SectionHeaderComponent | Settings | WriteComponent | _AgentStart | calloutComponent_AsList | linkComponent_AsList | metaComponent_AsList | popoverComponent_AsList | postsItem_AsList | sectionHeaderComponent_AsList | writeComponent_AsList) & { __isUnion?: true }
...
export type BlockList = (Contributions | NavLinks | Posts | calloutComponent_AsList | linkComponent_AsList | metaComponent_AsList | popoverComponent_AsList | postsItem_AsList | sectionHeaderComponent_AsList | writeComponent_AsList) & { __isUnion?: true }
...
/** Rich text block */
export type BlockRichText = (Bio | Body | Content | Content_1 | Description | Subtitle) & { __isUnion?: true }
...
export interface Index {
    ...
    recentContributionsSection: RecentContributionsSection
    title: Scalars['String']
    __typename: 'Index'
}
...
export interface RecentContributionsSection {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
    ...
    __typename: 'RecentContributionsSection'
}
...
export type RichTextJson = (BaseRichTextJson | BioRichText | BodyRichText | ContentRichText | Content_1RichText | DescriptionRichText | SubtitleRichText) & { __isUnion?: true }
...
export type SectionHeaderComponentOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'subtitle__ASC' | 'subtitle__DESC' | 'title__ASC' | 'title__DESC' | 'untitled__ASC' | 'untitled__DESC'
...
export interface WriteComponent {
    ...
    _sys: BlockDocumentSys
    _title: Scalars['String']
    added: (Scalars['String'] | null)
    clicks: Clicks
    description: (Description | null)
    href: (Scalars['String'] | null)
    icon: (Scalars['BSHBSelect__1970461833'] | null)
    label: Scalars['String']
    removed: (Scalars['String'] | null)
    type: (Scalars['BSHBSelect_1985231500'] | null)
    __typename: 'WriteComponent'
}

export type WriteComponentOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'added__ASC' | 'added__DESC' | 'clicks__ASC' | 'clicks__DESC' | 'description__ASC' | 'description__DESC' | 'href__ASC' | 'href__DESC' | 'icon__ASC' | 'icon__DESC' | 'label__ASC' | 'label__DESC' | 'removed__ASC' | 'removed__DESC' | 'type__ASC' | 'type__DESC' | 'untitled_1__ASC' | 'untitled_1__DESC' | 'untitled__ASC' | 'untitled__DESC'
...
export interface BlockDocumentGenqlSelection{
    ...
    on_Contributions?: ContributionsGenqlSelection
    ...
    on_RecentContributionsSection?: RecentContributionsSectionGenqlSelection
...
export interface ContributionsGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface IndexGenqlSelection{
    ...
    recentContributionsSection?: RecentContributionsSectionGenqlSelection
    title?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "Index"
}
...
export interface RecentContributionsSectionGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _sys?: BlockDocumentSysGenqlSelection
    _title?: boolean | number
    contributions?: (ContributionsGenqlSelection & { __args?: {
    /** Filter by a field. */
    ...
    __typename?: boolean | number
    __fragmentOn?: "RecentContributionsSection"
}
...
export interface WriteComponentFilterInput {AND?: (WriteComponentFilterInput | null),OR?: (WriteComponentFilterInput | null),_id?: (StringFilter | null),_slug?: (StringFilter | null),_sys_apiNamePath?: (StringFilter | null),_sys_createdAt?: (DateFilter | null),_sys_hash?: (StringFilter | null),_sys_id?: (StringFilter | null),_sys_idPath?: (StringFilter | null),_sys_lastModifiedAt?: (DateFilter | null),_sys_slug?: (StringFilter | null),_sys_slugPath?: (StringFilter | null),_sys_title?: (StringFilter | null),_title?: (StringFilter | null),added?: (StringFilter | null),href?: (StringFilter | null),icon?: (SelectFilter | null),label?: (StringFilter | null),removed?: (StringFilter | null),type?: (SelectFilter | null)}
...
export interface FragmentsMap {
  ...
  Contributions: {
    root: Contributions,
    selection: ContributionsGenqlSelection,
}
  Description: {
    root: Description,
  ...
  RecentContributionsSection: {
    root: RecentContributionsSection,
    selection: RecentContributionsSectionGenqlSelection,
}
  RepoSys: {
    root: RepoSys,
