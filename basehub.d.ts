...
export type BlockDocument = (CalloutComponent | Components | Contributions | Fonts | Header | Index | LinkComponent | MetaComponent | NavLinks | PopoverComponent | Posts | PostsItem | PostsSection | RecentContributionsSection | SectionHeaderComponent | Settings | WriteComponent | calloutComponent_AsList | linkComponent_AsList | metaComponent_AsList | popoverComponent_AsList | postsItem_AsList | sectionHeaderComponent_AsList | writeComponent_AsList) & { __isUnion?: true }
